...
def stop_controller():
    """Stop the accessibility controller"""
    global is_running
...
def get_status():
    ...
    try:
        return jsonify({
            ...
            "cursor_mode": controller.cursor_mode,
            "voice_enabled": controller.voice_enabled,
            "current_gesture": controller.current_gesture,
            "hand_detected": hand_detected,
            "hand_count": hand_count,
...
def start_training():
    ...
    try:
        ...
        if success:
            ...
            return jsonify({"status": "error", "message": f"Failed to start training for {gesture}"})
...
def save_model():
    ...
    try:
        ...
        if success:
            ...
            return jsonify({"status": "error", "message": "Failed to save model"})
...
def reset_training():
    ...
    try:
        ...
        if success:
            ...
            return jsonify({"status": "error", "message": "Failed to reset training data"})
